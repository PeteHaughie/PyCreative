"""GL upload + readback test sketch (clean)

Clean copy of gl_upload_test that tests the presenter's texture upload
and a trivial shader compile/draw. This file contains no markdown
fences and should import cleanly.
"""
...
class Sketch:
    def setup(self):
        self.size(320, 240)
        self.window_title('GL upload test (clean)')
        self.test_w = 16
        self.test_h = 16
        self._pil = Image.new('RGBA', (self.test_w, self.test_h), (255, 0, 255, 255))
