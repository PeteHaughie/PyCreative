"""GL upload + readback test sketch (fixed)

Clean copy of gl_upload_test.py without stray markdown fences. This
file exercises the presenter's texture upload/readback helper and
attempts a trivial shader compile/draw readback.
"""
...
class Sketch:
    def setup(self):
        self.size(320, 240)
        self.window_title('GL upload test (fixed)')
