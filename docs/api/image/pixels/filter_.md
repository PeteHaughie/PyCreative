[docs](/docs/)→[api](/docs/api)→[image](/docs/api/image)→[pixels](/docs/api/image/pixels)→[filter()](/docs/api/image/pixels/filter_.md)
...
| Input | Description |
|-------|-------------|
| shader	(PCShader) | the fragment shader to apply |
| kind	(String) | Either "THRESHOLD", "GRAY", "OPAQUE", "INVERT", "POSTERIZE", "BLUR", "ERODE", or "DILATE" |
