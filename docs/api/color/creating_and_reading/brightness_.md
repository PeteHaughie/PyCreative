[docs](/docs/)→[api](/docs/api)→[color](/docs/api/color/)→[creating_and_reading](/docs/api/color/creating_and_reading/)→[brightness_.md](/docs/api/color/creating_and_reading/brightness_.md)
