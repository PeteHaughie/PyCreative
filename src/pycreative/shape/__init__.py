...
try:
	...
	from .skia_svg_adapter import load_shape, load_svg  # type: ignore
except Exception:
	try:
		from .svgpy_loader import load_shape, load_svg  # type: ignore
	except Exception:
		from .loader import load_shape, load_svg  # type: ignore
